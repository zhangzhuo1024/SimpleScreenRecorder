...
public class WaveView extends View {
    ...
    private void setPath() {
        ...
        for (int i = 0; i < width; i++) {
            x = i;
            y = (int) (isPause * 20 * Math.sin(i * 2 * 0.7f * Math.PI / width + swing) + height * 0.5);
            if (i == 0) {
        ...
        for (int i = 0; i < width; i++) {
            x = i;
            y = (int) (isPause * 20 * Math.cos(i * 2 * 0.7f * Math.PI / width + swing + 0.3f) + height * 0.5);
            if (i == 0) {
                path2.moveTo(x, y);
            }
        ...
        for (int i = 0; i < width; i++) {
            x = i;
            y = (int) (isPause * 20 * Math.sin(i * 2 * 0.7f * Math.PI / width + swing + 0.6f) + height * 0.5);
            if (i == 0) {
                path3.moveTo(x, y);
            }
